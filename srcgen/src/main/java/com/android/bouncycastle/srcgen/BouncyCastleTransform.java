...
import static com.google.currysrc.api.process.ProcessorSupport.createMandatoryRule;
import static com.google.currysrc.api.process.ProcessorSupport.createOptionalRule;
...
import com.google.currysrc.api.process.ProcessorSupport;
...
public class BouncyCastleTransform {
    ...
    static class TransformRules implements Rules {
        ...
        public List<Rule> getRuleList(File ignored) {
            return Arrays.asList(
                    ...
                    createOptionalRule(new AddAnnotation("libcore.api.CorePlatformApi",
                        ProcessorSupport.readBodyDeclarationLocations(corePlatformApiFile)))
                    );
        }
